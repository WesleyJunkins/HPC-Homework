...
time ./lifeCUDA 5000 5000 5000 1 /scratch/$USER/cudaOutputs
time ./lifeCUDA 5000 5000 5000 1 /scratch/$USER/cudaOutputs
time ./lifeCUDA 5000 5000 5000 1 /scratch/$USER/cudaOutputs
echo "------------------------------------------------------------------------------------------------------------------------"
echo "CUDA 10000x10000 3 tests"
time ./lifeCUDA 10000 10000 5000 1 /scratch/$USER/cudaOutputs
time ./lifeCUDA 10000 10000 5000 1 /scratch/$USER/cudaOutputs
time ./lifeCUDA 10000 10000 5000 1 /scratch/$USER/cudaOutputs
echo "------------------------------------------------------------------------------------------------------------------------"
echo "CUDA Improved 5000x5000 3 tests"
time ./lifeCUDAimproved 5000 5000 5000 1 /scratch/$USER/cudaImprovedOutputs
time ./lifeCUDAimproved 5000 5000 5000 1 /scratch/$USER/cudaImprovedOutputs
time ./lifeCUDAimproved 5000 5000 5000 1 /scratch/$USER/cudaImprovedOutputs
echo "------------------------------------------------------------------------------------------------------------------------"
echo "CUDA Improved 10000x10000 3 tests"
time ./lifeCUDAimproved 10000 10000 5000 1 /scratch/$USER/cudaImprovedOutputs
time ./lifeCUDAimproved 10000 10000 5000 1 /scratch/$USER/cudaImprovedOutputs
time ./lifeCUDAimproved 10000 10000 5000 1 /scratch/$USER/cudaImprovedOutputs
echo "------------------------------------------------------------------------------------------------------------------------"
